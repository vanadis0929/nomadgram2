"""
Django settings for nomadgram2 project.
...
LOCAL_APPS = [
    ...
    'nomadgram2.images.apps.ImagesConfig',  # images app
    'nomadgram2.notifications.apps.NotificationsConfig'  # notifications app
]
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:1234@localhost:5432/nomadgram2'),
